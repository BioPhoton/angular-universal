...
export class SetLangDirective implements OnChanges, OnDestroy {
  ...
  set appSetLang(lang: string) {
    const newCommands: string[] = this.translationManagerService.getExternalUrlWithoutLang(this.translationManagerService.getExternalUrl(this.urlTree)).split('/');
